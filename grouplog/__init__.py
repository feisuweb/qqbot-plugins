...
def insertUser(bot,contact,member,content):
	# 连接数据库  
	...
	# 插入数据  
	sql = "INSERT INTO users (`qq`,`uin`,`nickname`,`group_mark`,`from_group`,`from_group_number`,`create_time`,`update_time`) VALUES ( '%s', '%s', '%s','%s','%s', '%s', '%s', '%s')"  
